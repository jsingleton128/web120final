...
#EDIT THE FOLLOWING:
$toAddress = "jerrelgayle@gmail.com";  //place your/your client's email address here
$toName = "Stetson Wilson"; //place your client's name here
$website = "isabellaextynn.com";  //place NAME of your client's website here
#--------------END CONFIG AREA ------------------------#
...
if ($response != null && $response->success)
    ...
    <div class="contact-feedback">
        ...
        <p>Thank you!</p>
        <p>You'll receive via email within 48 hours, if your email requires a response.</p>
    </div>    
    <!-- END HTML FEEDBACK -->        
    <?php
...
?>
    ...
    <p>If you want to send me some fan mail or inquire about booking, please use the form below.</p>
	<div>
		<label>
...
<div><label>Type:<br />
<select name="type">
    <option value="generalComment" selected>General Comment</option>
    <option value="bookingInquiry">Booking Inquiry</option>
</select>
<textarea name="message" placeholder = "Your message goes here." tabindex="30">
</textarea></label></div>
<div><?=$feedback?></div>
